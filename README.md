...
alias start="proot-distro login ubuntu --shared-tmp --no-sysvipc"' > ~/.bashrc && termux-reload-settings && . ~/.bashrc
```
#### 1.2 Chroot ubuntu 
```
su -c /data/adb/magisk/busybox wget https://github.com/xDoge26/proot-setup/raw/main/Chroot/Test_install.sh && bash ./Test_install.sh && . ~/.bashrc ; su -c rm -rf ./Test_install.sh
```
## 2. Install xfce
```
wget https://github.com/xDoge26/proot-setup/raw/main/xfce4.sh ; bash ./xfce4.sh ; rm --force xfce4.sh
```
## 3. Install box86/box64
```
wget https://github.com/xDoge26/proot-setup/raw/main/box86_64.sh ; bash ./box86_64.sh ; rm --force box86_64.sh
```
## 4. VirGL
